...
use crate::modules::stack::transport::{balancer, health};
...
pub struct UdpProtocolRule {
	#[validate(regex(
        path = *crate::modules::stack::transport::model::NAME_REGEX,
	...
	pub priority: u32,
	#[validate(nested)]
	pub detect: crate::modules::stack::transport::model::Detect,
	#[validate(nested)]
